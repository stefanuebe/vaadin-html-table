 ...
 */
public abstract class AbstractTableViewTest extends ParallelTest {
    ...
    protected AbstractTableViewTest(String route) {
        this.route = route;
    }

    protected AbstractTableViewTest(Class<? extends Component> view) {
        this.route = view.getAnnotation(Route.class).value();
    }
    ...
    protected void assertOptionalNotPresent(String property, Supplier<Optional<?>> supplier) {
        Assert.assertFalse(property + " must not be present", supplier.get().isPresent());
    }

    protected void assertOptionalPresent(String property, Supplier<Optional<?>> supplier) {
        Assert.assertTrue(property + " must be present", supplier.get().isPresent());
    }
}